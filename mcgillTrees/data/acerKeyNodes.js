...
const ACER_KEY_NODES = {
  ...
  root: {
    id: "root",
    type: "question",
    text: "1. Leaf type (compound vs simple).",
    options: [
      {
        id: "1-acer-negundo",
  ...
  "acer-2": {
    id: "acer-2",
    type: "question",
    text: "2. Milky sap in petiole and leaf shape.",
    options: [
      {
  ...
  "acer-3": {
    id: "acer-3",
    type: "question",
    text: "3. Depth of leaf lobing and lower lobe orientation.",
    options: [
      {
  ...
  "acer-4": {
    id: "acer-4",
    type: "question",
    text: "4. Leaf size and margin character.",
    options: [
      {
        id: "4-acer-ginnala",
        label:
  ...
  "acer-5": {
    id: "acer-5",
    type: "question",
    text: "5. Shape of leaf sinuses and bark/sap characters.",
    options: [
      {
        id: "5-acer-saccharum",
        label:
