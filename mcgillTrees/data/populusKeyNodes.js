...
const POPULUS_KEY_NODES = {
  ...
  root: {
    id: "root",
    type: "question",
    text: "1. Leaf underside texture and bark colour.",
    options: [
      {
        id: "1-white-poplar",
        label:
  ...
  "populus-2": {
    ...
    type: "question",
    text:
      "2. Leaf stalk shape (strongly flattened vs not) and leaf trembling behavior.",
    options: [
      {
  ...
  "populus-3": {
    ...
    type: "question",
    text:
      "3. Leaf size/shape and bark character for trembling vs bigtooth aspens.",
    options: [
      {
  ...
  "populus-4": {
    ...
    type: "question",
    text:
      "4. Large triangular leaves with thick, deep-furrowed bark vs other poplars.",
    options: [
      {
  ...
  "populus-5": {
    ...
    type: "question",
    text:
      "5. Leaf aroma, bud resin, and twig fragrance (Balsam vs others with triangular/diamond leaves).",
    options: [
      {
        id: "5-balsam-poplar",
        label:
  ...
  "populus-6": {
    ...
    type: "question",
    text:
      "6. Leaf shape and crown form (very upright Black Poplar vs variable hybrid).",
    options: [
      {
        id: "6-black-poplar",
        label:
