...
const MALUS_KEY_NODES = {
  ...
  root: {
    id: "root",
    type: "question",
    text: "1. Fruit size and tree form.",
    options: [
      {
        id: "1-domestic-apple",
        label:
  ...
  "malus-2": {
    ...
    type: "question",
    text:
      "2. Fruit size and colour (very small bright fruits vs slightly larger aromatic ones).",
    options: [
      {
  ...
  "malus-3": {
    ...
    type: "question",
    text:
      "3. Leaf underside texture and fruit character (smooth vs slightly hairy and blotchy).",
    options: [
      {
