...
const GLEDITSIA_KEY_NODES = {
  ...
  root: {
    id: "root",
    type: "question",
    text: "1. Presence of stout thorns on trunk and branches.",
    options: [
      {
        id: "1-honeylocust",
        label:
  ...
  "gleditsia-2": {
    ...
    type: "question",
    text:
      "2. Leaf form and pods (mixed bipinnate/pinnate, long twisted pods vs strictly pinnate with shorter pods).",
    options: [
      {
