...
const PRUNUS_KEY_NODES = {
  ...
  root: {
    id: "root",
    type: "question",
    text: "1. Overall tree size and bark/leaf character.",
    options: [
      {
        id: "1-black-cherry",
        label:
  ...
  "prunus-2": {
    ...
    type: "question",
    text:
      "2. Leaf width and fruit characters (very narrow leaves with tiny bright red fruits vs broader leaves).",
    options: [
      {
        id: "2-pin-cherry",
        label:
  ...
  "prunus-3": {
    ...
    type: "question",
    text:
      "3. Leaf size/finish and how the fruits are arranged along the twigs.",
    options: [
      {
        id: "3-chokecherry",
        label:
  ...
  "prunus-4": {
    ...
    type: "question",
    text:
      "4. Flower clusters and size of the resulting cherries (small black vs larger sweet/sour cherries).",
    options: [
      {
        id: "4-bird-cherry",
        label:
  ...
  "prunus-5": {
    ...
    type: "question",
    text:
      "5. Taste, habit, and bud arrangement (cultivated sweet cherry vs sour cherry).",
    options: [
      {
        id: "5-sweet-cherry",
        label:
