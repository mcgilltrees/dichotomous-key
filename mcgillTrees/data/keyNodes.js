...
const KEY_NODES = {
  ...
  root: {
    id: "root",
    type: "question",
    text: "1. What do the leaves look like overall?",
    options: [
      {
        id: "root-needlelike",
  ...
  "sec1-2": {
    id: "sec1-2",
    type: "question",
    text: "2. Needle vs scale foliage?",
    options: [
      {
        id: "sec1-2-scale",
  ...
  "sec1-3": {
    id: "sec1-3",
    type: "question",
    text: "3. How are the needles attached?",
    options: [
      {
        id: "sec1-3-clusters",
  ...
  "sec1-4": {
    id: "sec1-4",
    type: "question",
    text: "4. Needle clusters and seasonality",
    options: [
      {
        id: "sec1-4-larch",
  ...
  "sec1-5": {
    id: "sec1-5",
    type: "question",
    text: "5. Needle cross-section and cones",
    options: [
      {
        id: "sec1-5-flat",
  ...
  "sec1-6": {
    id: "sec1-6",
    type: "question",
    text: "6. Spruce vs hemlock characters",
    options: [
      {
        id: "sec1-6-spruce",
  ...
  "sec1-7": {
    id: "sec1-7",
    type: "question",
    text: "7. How are the leaves arranged on the twig?",
    options: [
      {
        id: "sec1-7-opposite",
  ...
  "sec1-8": {
    id: "sec1-8",
    type: "question",
    text: "8. Are the opposite leaves simple or compound?",
    options: [
      {
        id: "sec1-8-simple",
  ...
  "sec1-9": {
    id: "sec1-9",
    type: "question",
    text: "9. Opposite compound leaves",
    options: [
      {
        id: "sec1-9-fraxinus",
  ...
  "sec1-11": {
    id: "sec1-11",
    type: "question",
    text: "11. Are the alternate leaves compound or simple?",
    options: [
      {
        id: "sec1-11-compound",
  ...
  "sec1-12": {
    id: "sec1-12",
    type: "question",
    text: "12. Leaflet number and thorns",
    options: [
      {
  ...
  "sec1-13": {
    id: "sec1-13",
    type: "question",
    text: "13. Compound-leaf broadleaf genera",
    options: [
      {
        id: "sec1-13-juglans",
  ...
  "sec1-17": {
    id: "sec1-17",
    type: "question",
    text: "17. Lobed leaf tips and fruit type",
    options: [
      {
        id: "sec1-17-oak",
  ...
  "sec1-18": {
    id: "sec1-18",
    type: "question",
    text: "18. Leaf arrangement for lobed leaves without acorns",
    options: [
      {
        id: "sec1-18-acer",
  ...
  "sec1-19": {
    id: "sec1-19",
    type: "question",
    text: "19. Lobed alternate leaves",
    options: [
      {
  ...
  "sec1-23": {
    id: "sec1-23",
    type: "question",
    text: "23. Leaf shape and catkins",
    options: [
      {
        id: "sec1-23-salix",
  ...
  "sec1-26": {
    id: "sec1-26",
    type: "question",
    text: "26. Small trees/shrubs with berries",
    options: [
      {
  ...
  "sec1-27": {
    id: "sec1-27",
    type: "question",
    text: "27. Fruit type in Rosaceae trees",
    options: [
      {
        id: "sec1-27-pome",
