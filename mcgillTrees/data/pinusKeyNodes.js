...
const PINUS_KEY_NODES = {
  ...
  root: {
    id: "root",
    type: "question",
    text: "1. Needles per bundle (fascicle) and their feel.",
    options: [
      {
  ...
  "pinus-2": {
    id: "pinus-2",
    type: "question",
    text: "2. Bundles strictly of 2 needles vs 3 (or mixed 2–3).",
    options: [
      {
        id: "2-two-needles",
  ...
  "pinus-3": {
    ...
    type: "question",
    text:
      "3. Needle length and bark colour (Red Pine vs Scots Pine among 2-needled pines).",
    options: [
      {
        id: "3-red-pine",
        label:
  ...
  "pinus-4": {
    ...
    type: "question",
    text:
      "4. Bark character and cone/branch persistence (Austrian vs Pitch Pine).",
    options: [
      {
        id: "4-austrian-pine",
        label:
