...
const CRATAEGUS_KEY_NODES = {
  ...
  root: {
    id: "root",
    type: "question",
    text: "1. Thorn length and leaf appearance.",
    options: [
      {
  ...
  "crataegus-2": {
    ...
    type: "question",
    text:
      "2. Leaf shape and fruit cluster size (triangular-ovate vs other forms).",
    options: [
      {
  ...
  "crataegus-3": {
    ...
    type: "question",
    text:
      "3. Leaf underside pubescence and flower size (Downy vs non-downy hawthorns).",
    options: [
      {
        id: "3-downy-hawthorn",
        label:
  ...
  "crataegus-4": {
    ...
    type: "question",
    text:
      "4. Leaf lobing and fruit size (narrowly lobed vs more rounded, shallow-lobed leaves).",
    options: [
      {
