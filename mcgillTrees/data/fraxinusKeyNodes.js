...
const FRAXINUS_KEY_NODES = {
  ...
  root: {
    id: "root",
    type: "question",
    text: "1. How are the leaflets attached, and how do they feel?",
    options: [
      {
  ...
  "fraxinus-2": {
    ...
    type: "question",
    text:
      "2. Check the underside colour and thickness of the leaflets, and the bud scar shape.",
    options: [
      {
        id: "2-white-ash",
        label:
  ...
  "fraxinus-3": {
    ...
    type: "question",
    text:
      "3. Count leaflet number and look at twig shape and bark pattern.",
    options: [
      {
        id: "3-green-ash",
        label:
