...
const BETULA_KEY_NODES = {
  ...
  root: {
    id: "root",
    type: "question",
    text: "1. Bark character and colour on the trunk.",
    options: [
      {
        id: "1-paper-birch",
        label:
  ...
  "betula-2": {
    ...
    type: "question",
    text:
      "2. Bark exfoliation style and colour (shaggy salmon vs thinner curls/scales).",
    options: [
      {
        id: "2-river-birch",
        label:
  ...
  "betula-3": {
    ...
    type: "question",
    text:
      "3. Wintergreen odor of twigs and bark colour (bronze-yellow vs chalk-white/gray).",
    options: [
      {
        id: "3-yellow-birch",
        label:
  ...
  "betula-4": {
    ...
    type: "question",
    text:
      "4. Bark whiteness, trunk form, and leaf shape (chalk-white vs grayish smaller tree).",
    options: [
      {
        id: "4-european-white",
        label:
