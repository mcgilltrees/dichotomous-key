...
const SALIX_KEY_NODES = {
  ...
  root: {
    id: "root",
    type: "question",
    text: "1. Overall crown form and branchlet habit.",
    options: [
      {
        id: "1-weeping-willow",
        label:
  ...
  "salix-2": {
    ...
    type: "question",
    text:
      "2. Leaf length/width and underside colour (whitish vs greener) and bark colour.",
    options: [
      {
        id: "2-white-willow",
        label:
  ...
  "salix-3": {
    ...
    type: "question",
    text:
      "3. Brittleness of twigs at base and leaf gloss (Crack Willow vs others).",
    options: [
      {
        id: "3-crack-willow",
        label:
  ...
  "salix-4": {
    ...
    type: "question",
    text:
      "4. Leaf width and stem colour (very narrow, reddish twigs vs broader leaves on dark-barked trees).",
    options: [
      {
        id: "4-purple-willow",
        label:
