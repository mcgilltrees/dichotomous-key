...
const PICEA_KEY_NODES = {
  ...
  root: {
    ...
    type: "question",
    questionNumber: 1,
    text: "Look at the cones and overall branch form.",
    options: [
      {
        id: "1-norway-spruce",
        label:
  ...
  "picea-2": {
    ...
    type: "question",
    questionNumber: 2,
    text: "What colour are the needles overall?",
    options: [
      {
  ...
  "picea-3": {
    ...
    type: "question",
    questionNumber: 3,
    text: "Needle length, cone size, and crown shape (narrow bog spruce vs broader forms).",
    options: [
      {
        id: "3-black-spruce",
        label:
  ...
  "picea-4": {
    ...
    type: "question",
    questionNumber: 4,
    text: "Cone shape and subtle needle colour/branch attitude (White vs Serbian spruce).",
    options: [
      {
        id: "4-white-spruce",
        label:
