...
const ULMUS_KEY_NODES = {
  ...
  root: {
    ...
    type: "question",
    questionNumber: 1,
    text: "How big and how rough are the leaves?",
    options: [
      {
        id: "1-small-harsh",
        label:
  ...
  "ulmus-2": {
    ...
    type: "question",
    questionNumber: 2,
    text: "Feel the underside of the leaf and look at the buds and twig surface.",
    options: [
      {
        id: "2-slippery-elm",
        label:
  ...
  "ulmus-3": {
    ...
    type: "question",
    questionNumber: 3,
    text: "Overall leaf size/shape and tree form (vase-shaped vs more massive leaves).",
    options: [
      {
        id: "3-american-elm",
        label:
