...
const AMELANCHIER_KEY_NODES = {
  ...
  root: {
    ...
    type: "question",
    questionNumber: 1,
    text: "Hairiness of young leaves and overall leaf colour.",
    options: [
      {
  ...
  "amelanchier-2": {
    ...
    type: "question",
    questionNumber: 2,
    text: "Emerging leaf colour, serration pattern, and petal shape/posture.",
    options: [
      {
  ...
  "amelanchier-3": {
    ...
    type: "question",
    questionNumber: 3,
    text: "Growth habit and berry size/colour (shrubby Canadian vs larger Saskatoon).",
    options: [
      {
