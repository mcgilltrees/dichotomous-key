...
const QUERCUS_KEY_NODES = {
  ...
  root: {
    ...
    type: "question",
    questionNumber: 1,
    text: "What do the leaf lobes look like at their tips?",
    options: [
      {
        id: "1-bristle",
  ...
  "red-2": {
    ...
    type: "question",
    questionNumber: 2,
    text: "How deep are the sinuses between the lobes?",
    options: [
      {
        id: "2-deep-sinuses",
  ...
  "red-3": {
    ...
    type: "question",
    questionNumber: 3,
    text: "Slender lobes vs very drooping lower branches with extremely deep lowest sinuses",
    options: [
      {
        id: "3-scarlet-oak",
        label:
  ...
  "red-4": {
    ...
    type: "question",
    questionNumber: 4,
    text: "Broad, sharply pointed lobes vs glossy leaves with yellowish midrib",
    options: [
      {
  ...
  "white-6": {
    ...
    type: "question",
    questionNumber: 6,
    text: "How deep and fringed are the rounded lobes and acorn cups?",
    options: [
      {
        id: "6-bur-oak",
        label:
  ...
  "white-7": {
    ...
    type: "question",
    questionNumber: 7,
    text: "Shallow rounded lobes vs few lobes near tip with velvety underside",
    options: [
      {
        id: "7-white-oak",
        label:
