...
const TILIA_KEY_NODES = {
  ...
  "tilia-2": {
    ...
    type: "question",
    questionNumber: 2,
    text: "Leaf size and lower-surface texture (very large and velvety vs moderately large).",
    options: [
      {
  ...
  "tilia-3": {
    ...
    type: "question",
    questionNumber: 3,
    text: "Leaf shape, serration, and twig/bud characters (Bigleaf vs Common/Hybrid Linden).",
    options: [
      {
        id: "3-bigleaf-linden",
        label:
